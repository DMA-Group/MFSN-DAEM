...
def do_ER(src_dataset,tgt_dataset,batch_size,BERT_type,seed,args):
    ...
    parm_dic = {"BERT": BERT_type, "src":src_dataset,"tgt":tgt_dataset,"batch_size": batch_size, "num_epochs": args.num_epochs, "max_seq":args.max_seq,
...
def do_basic_GRL(src,tgt,batch_size,seed,cuda_id):
